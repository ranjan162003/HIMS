...
const ElectricalScreen = () => {
  ...
  const accessories = ['Switch Box', 'Fan', 'Light', 'Other']; // List of carpentry accessories including "Other"
  const issues = ['Broken', 'Malfunction', 'Wirecut','Other']; // Common issues for carpentry accessories
